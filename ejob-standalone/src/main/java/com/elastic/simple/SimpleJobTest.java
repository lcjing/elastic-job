...
public class SimpleJobTest {
    public static void main(String[] args) {
        // ZK注册中心
        CoordinatorRegistryCenter regCenter = new ZookeeperRegistryCenter(new ZookeeperConfiguration("172.24.1.101:31512", "elastic-job-standalone"));
        regCenter.init();
